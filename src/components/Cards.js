      ...
      <div className="cards-container">
        <div className="cards-wrapper">
          <ul className="cards-items">
            <CardItem
              src={require("../components/assets/img-brewhound.jpg")}
            ...
            />
            <CardItem
              src={require("../components/assets/img-thought.jpg")}
          ...
          <ul className="cards-items">
            <CardItem
              src={require("../components/assets/img-bookfinder.jpg")}
            ...
            />
            <CardItem
              src={require("../components/assets/img-retail.jpg")}
            ...
            />
            <CardItem
              src={require("../components/assets/img-shop.jpg")}
